...
* [ ] If the asset is moved into a BIA Production Workspace, direct workspace access is restricted to BIA users
* [ ] Non-BIA users will consume approved production outputs through approved report/app sharing channels, not direct workspace membership
...
* [ ] BIA review is required if the asset enters a BIA Production Workspace
...
* [ ] If the asset enters a BIA Production Workspace, direct workspace access remains restricted to BIA users
* [ ] Non-BIA users will access approved outputs through approved report/app sharing channels
...
* [ ] If moved into BIA Production Workspace, direct workspace access is restricted to BIA users
* [ ] Non-BIA users consume approved outputs through approved sharing channels

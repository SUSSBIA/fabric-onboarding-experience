...
This section collects useful Microsoft documentation, Microsoft Learn modules, and selected video learning resources that support the Fabric Onboarding Guide.

The main onboarding guide is written for the University’s operating context. These resources provide official product documentation, deeper technical learning, and optional self-paced study.
...
Microsoft documentation should be treated as the official product reference.

Curated videos can be helpful for explanation and demonstration, but they should not replace official documentation for governance, licensing, security, or production decisions.
...
This placeholder will be used to collect selected videos that support Fabric onboarding, persona pathways, and sandbox experiments.
...
Suggested video inventory format:
...
When using curated videos, learners should remember:

* Official Microsoft documentation remains the primary product reference.
* Videos may become outdated as Fabric changes.
* Videos should be used to supplement, not replace, the onboarding guide and official documentation.
* Governance, licensing, security, and production decisions should be based on official guidance and local operating model expectations.

...
In the current operating model, onboarding activities begin in sandbox. Department workspaces support approved department-level exploration and development. BIA production workspaces are reserved for BIA-managed production assets.
